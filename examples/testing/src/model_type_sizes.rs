...
pub fn print_ranking() {
    let sizes = [
        ...
        ("AnimationType", std::mem::size_of::<AnimationType>()),
        ...
        ("Error", std::mem::size_of::<serenity::Error>()),
        ("ModelError", std::mem::size_of::<serenity::model::ModelError>()),
        ("GatewayError", std::mem::size_of::<serenity::gateway::GatewayError>()),
        ...
        ("VoiceChannelEffect", std::mem::size_of::<VoiceChannelEffect>()),
        ("VoiceChannelEffectSendEvent", std::mem::size_of::<VoiceChannelEffectSendEvent>()),
